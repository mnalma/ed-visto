!(function (e, t) {
  ...
  var L,
    I =
      ((L = 'undefined' != typeof Uint8Array && v(Uint8Array)),
      function (e) {
    ...
    function f (e, r, i) {
      ...
      if (e && !i && 'object' === n(e))
        if (G.endsWith(r, '{}'))
          ...
          ((G.isFileList(e) || G.endsWith(r, '[]')) && (u = G.toArray(e)))
        )
          return (
            (r = Y(r)),
            ...
            G.forEach(n, function (n, o) {
              !0 ===
                (!(G.isUndefined(n) || null === n) &&
                  i.call(t, n, G.isString(o) ? o.trim() : o, r, d)) &&
                e(n, r ? r.concat(o) : [o])
            }),
            l.pop()
        }
  ...
  var ue,
    ...
    pe =
      ...
      de && ['ReactNative', 'NativeScript', 'NS'].indexOf(ue) < 0),
    he =
  ...
  function ye (e) {
    function t (e, n, r, o) {
      var i = e[o++],
        ...
        s = o >= e.length
      return (
        (i = !i && G.isArray(r) ? r.length : i),
        s
          ? (G.hasOwnProp(r, i) ? (r[i] = [r[i], n]) : (r[i] = n), !a)
          : ((r[i] && G.isObject(r[i])) || (r[i] = []),
            t(e, n, r[i], o) &&
              G.isArray(r[i]) &&
              (r[i] = (function (e) {
                var t,
          ...
          },
          {
            ...
            value: function (e) {
              var t = this,
                n = {}
              return (
                G.forEach(this, function (r, o) {
                  var i = G.findKey(n, o)
                  if (i) return (t[i] = Ee(r)), void delete t[o]
                  var a = e
                    ? (function (e) {
                        return e
                          .trim()
  ...
  var Ce = me.hasStandardBrowserEnv
    ? (function () {
        var e,
        ...
        return new Promise(function (t, n) {
          ...
          if (G.isFormData(a))
            if (me.hasStandardBrowserEnv || me.hasStandardBrowserWebWorkerEnv)
              ...
              var y = o
                ...
                g = v.slice(1)
              s.setContentType(
                [b || 'multipart/form-data'].concat(u(g)).join('; ')
              )
            }
          ...
          if (
            (w.open(
              ...
              se(S, e.params, e.paramsSerializer),
              !0
            ),
            (w.timeout = e.timeout),
            'onloadend' in w
            ...
            (w.onabort = function () {
              w &&
                (n(new X('Request aborted', X.ECONNABORTED, e, w)), (w = null))
            }),
            (w.onerror = function () {
              n(new X('Network Error', X.ERR_NETWORK, e, w)), (w = null)
            }),
            ...
            me.hasStandardBrowserEnv &&
              (h && G.isFunction(h) && (h = h(e)), h || (!1 !== h && Ce(S))))
          ) {
            var A =
              e.xsrfHeaderName && e.xsrfCookieName && Ne.read(e.xsrfCookieName)
            A && s.set(e.xsrfHeaderName, A)
          }
          void 0 === a && s.setContentType(null),
            'setRequestHeader' in w &&
              G.forEach(s.toJSON(), function (e, t) {
            ...
            'function' == typeof e.onDownloadProgress &&
              w.addEventListener('progress', ke(e.onDownloadProgress, !0)),
            'function' == typeof e.onUploadProgress &&
              w.upload &&
              w.upload.addEventListener('progress', ke(e.onUploadProgress)),
            (e.cancelToken || e.signal) &&
              ((r = function (t) {
                w &&
                  (n(!t || t.type ? new Pe(null, e, w) : t),
                  w.abort(),
                  (w = null))
              }),
          ...
          T && -1 === me.protocols.indexOf(T)
            ? n(new X('Unsupported protocol ' + T + ':', X.ERR_BAD_REQUEST, e))
            : w.send(a || null)
        })
      }
  }
  ...
  var Fe = function (e) {
    ...
    De = function (e) {
      for (
        var t, n, r = (e = G.isArray(e) ? e : [e]).length, o = {}, i = 0;
        i < r;
        i++
      ) {
        var a = void 0
  ...
  function Le (e) {
    return (
      ...
      De(e.adapter || be.adapter)(e).then(
        function (t) {
          return (
            Be(e),
      ...
      return (
        i(e, [
          ...
          },
          {
            ...
            value: function (e) {
              return se(
                xe((e = qe(this.defaults, e)).baseURL, e.url),
                e.params,
                e.paramsSerializer
              )
            }
  ...
  var Qe = (function e (t) {
    ...
    return (
      G.extend(r, Ve.prototype, n, { allOwnKeys: !0 }),
