...
!function (t, e) {
    ...
    function n(t, e) {
        for (var n = 0; n < e.length; n++) {
            var o = e[n];
            o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(t, (i = o.key, r = void 0, "symbol" == typeof (r = function (t, e) {
    ...
    var Ot = {innerParams: new WeakMap, domCache: new WeakMap},
        Lt = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], jt = function (t) {
            if (t.input) if (Rt[t.input]) {
                var e = qt(t.input), n = Rt[t.input](e, t);
    ...
    var _t = function (t, e) {
            ...
            }(0, e), _t(t, e), Tt(0, e), function (t, e) {
                var n = Z();
    ...
    var Tn, xn = function (t) {
        ...
        return Array.from(e.querySelectorAll("swal-param")).forEach((function (e) {
            _n(e, ["name", "value"]);
            var o = e.getAttribute("name"), i = e.getAttribute("value");
    ...
    var Zn = new WeakMap, $n = function () {
        ...
        return o(t, [{
            key: "_main", value: function (t) {
                ...
                }(Object.assign({}, e, t)), b.currentInstance && (b.currentInstance._destroy(), G() && ue()), b.currentInstance = Tn;
                var n = Xn(t, e);
                Yn(n), Object.freeze(n), b.timeout && (b.timeout.stop(), delete b.timeout), clearTimeout(b.restoreFocusTimeout);
                var o = Gn(Tn);
                return $t(Tn, n), Ot.innerParams.set(Tn, n), Jn(Tn, o, n)
            }
        }, {
    ...
    })), $n.DismissReason = Xt, $n.version = "11.10.0";
    var ro = $n;
